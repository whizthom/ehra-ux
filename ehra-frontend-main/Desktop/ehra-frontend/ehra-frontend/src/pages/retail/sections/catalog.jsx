...
function Customers({ items, onAdd, onEdit, onDelete }) {
  return (
    <>
      <Toolbar
        title="Customers"
        sub="Business-specific customer relationships, kept isolated to this business."
        action={
          <button className={s.primary} onClick={onAdd}>
            ＋ Add Customer
          </button>
      ...
      >
        ...
        {!items.length && (
          <Empty
            ...
            text="Add customers manually or let storefront interactions establish their business relationship."
            action={
              <button className={s.primary} onClick={onAdd}>
                Add customer
              </button>
